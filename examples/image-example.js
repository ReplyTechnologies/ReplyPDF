const fs = require('fs');
const { Container, Page, Text, Image, StackVertical, StackHorizontal } = require('../src/components/index.js');
...
module.exports = {
      ...
      header: new Container({
        ...
        children: [
          new StackHorizontal({
            children: [
              new Image({
                source: process.cwd() + '/examples/images/logo.png',
                width: 40,
                height: 40,
              }),
              new StackVertical({
  ...
  <path d="M39,20a15,15 0,0,0 0,20 M28,10a30,30 0,0,0 0,40 M61,20a15,15 0,0,1 0,20 M72,10a30,30 0,0,1 0,40" stroke="#3C3" fill="none" stroke-width="5" stroke-linecap="round"/>
                ...
                new Text({
                  text: 'Image from svg text binding:',
                }),
                new Image({
                  width: 100,
                  height: 100,
    ...
    const svgImage = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84 118">
    ...
    const svgImageUrl = 'https://dev.w3.org/SVG/tools/svgweb/samples/svg-files/cartman.svg';
